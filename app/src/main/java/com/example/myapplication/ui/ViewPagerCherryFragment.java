...
public class ViewPagerCherryFragment extends Fragment {
    private static final String TAG = "ViewPagerCherryFragment";
    FragmentViewPagerCherryBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentViewPagerCherryBinding.inflate(inflater);
